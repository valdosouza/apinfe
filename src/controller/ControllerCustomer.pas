...
uses System.Classes, System.SysUtils,BaseController,REST.json,
      ...
      ControllerEntityFiscal,     TypesCollection, prm_customer,objCustomer, tblPhone, tblAddress, tblMailing,ObjEntityFiscal,
...
function TControllerCustomer.getListSpl:String;
Var
  Lc_Qry :TFDQuery;
begin
  Try
