...
uses System.Classes, System.SysUtils,BaseController,
      ...
      ControllerOrderBilling, prm_to_invoice_sale, TypesCollection,
      ControllerFinancial,ObjOrderSale, tblOrderItem,
...
Type
  ...
  public
    ...
    function getListSpl : String;
    function getListSplByHour : String;
    function getListSplByDate : String;
...
begin
  ...
  Parametro   := TPrmToInvoiceSale.Create;
...
begin
  tRY
    ...
    Begin
      PaymentType.Institution.Estabelecimento := DObj.Estabelecimento;
      PaymentType.Registro.Descricao := DObj.FormaPagamento;
      PaymentType.getByDescripton;
      //
...
begin
  Parametro:= TJson.JsonToObject<TPrmToInvoiceSale>(par);
end;
...
begin
  ...
  Registro.Codigo           := parametro.Ordem;
  Registro.Terminal         := parametro.Terminal;
  Registro.Vendedor         := parametro.Vendedor;
  _getByKey(Registro);
end;
...
begin
  Try
    ...
    Begin
      ...
      ParamByName('id').AsInteger             := Parametro.Ordem;
      Active := True;
      FetchAll;
      get(Lc_Qry,Registro);
    End;
...
begin
  Try
    ...
    Begin
      ...
      if Parametro.Terminal > 0 then
        ParamByName('terminal').AsInteger := Parametro.Terminal;
...
function TControllerOrderSale.getListSpl: String;
Var
  Lc_Qry :TFDQuery;
begin
  Try
...
function TControllerOrderSale.getListSplByDate: String;
Var
  Lc_Qry :TFDQuery;
begin
  Try
...
function TControllerOrderSale.getListSplByHour: String;
Var
  Lc_Qry :TFDQuery;
begin
  Try
