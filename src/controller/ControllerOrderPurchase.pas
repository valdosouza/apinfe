...
function TControllerOrderPurchase.getListSpl: String;
Var
  Lc_Qry :TFDQuery;
begin
  Try
    ...
    Begin
      ...
      ParamByName('dataini').AsString := Parametro.DataInicial;
      ParamByName('datafim').AsString := Parametro.DataFinal;
...
function TControllerOrderPurchase.getListSplByDate: String;
Var
  Lc_Qry :TFDQuery;
begin
  Try
