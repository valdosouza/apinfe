...
Type
  ...
  public
    ...
    property DeterminacaoBase: String read Fdeterm_base write setFdeterm_base;

    [FieldName('determ_base_st')]
    property DeterminacaoBaseST: String read Fdeterm_base_st write setFdeterm_base_st;
